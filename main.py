...
if __name__ == "__main__":
    ucr = fetch_ucr_dataset('ScreenType', use_cache=False, data_home=None, return_X_y=False)  # 5 class
    ...
    PATH = "/home/sin/PycharmProjects/please/save/ScreenType/"
    #global best_acc
    #global best_loss
    best_acc = 0
    best_loss = 1
    ...
    for i in range(100):
        ...
        # summary(model, (choosed_channel_num,64,64), device = 'cuda')
        ...
        for epoch in range(epochs):
            ...
            for data in trainloader:
                ...
                with torch.no_grad():
                    for data in testloader:
                        val_input, val_target = data[0].to(device), data[1].to(device)
            ...
            if val_acc > best_acc:
                best_acc = val_acc
                #torch.save(model.state_dict(), PATH + 'ChlorineConcentration+ ctw .pt')
                print("saved")
            ...
            print(
                "=============================================================================================================================================================")
            print(
                f"TRAIN: EPOCH {epoch + 1:04d} / {epochs:04d} | Epoch LOSS {training_loss:.4f} | Epoch ACC {train_acc:.4f} | Val Loss {val_loss:.4f} | Val_acc {val_acc:.4f}")
            cost = running_loss / 6
        ...
        if best_test_acc < test_acc:
            ...
            torch.save(model.state_dict(), PATH + 'ScreenType.pt')
            print('save weight')
    ...
    accdf.to_csv("/home/sin/PycharmProjects/please/save/ScreenType/ScreenType.csv")
    end = time.time()
